...
function LogoPill({ label }) {
  return (
    <div className="mx-2 flex h-10 min-w-max items-center gap-2 rounded-full border border-ivory/10 bg-ivory/7 px-4 text-ivory/72 shadow-inner backdrop-blur-md">
...
export function LogoMarquee() {
  ...
  return (
    <section
      className="logo-marquee-fade relative mt-5 overflow-hidden rounded-[var(--radius-xl)] border border-ivory/10 bg-[linear-gradient(135deg,rgb(10_24_18/0.92),rgb(26_61_48/0.72),rgb(10_24_18/0.92))] py-3"
